...
var maxWidth = $(".img-member").width();
var StartAnimation = $(".img-member").offset().top + $(".img-member").height()/2 - maxWidth; 
...
if($(window).width() >= 992){ //apenas dispositivos onde são 3 membros por linha (width >= 992px)
	...
	$(window).scroll(function(){
		...
		var outerWidth = $(".img-member").outerWidth;

		if( MidScreen >= StartAnimation){
			
			size = (MidScreen - StartAnimation);
