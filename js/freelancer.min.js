...
var imgBottom = $(".img-member").offset().top + $(".img-member").height();
var teamBottom = $("#team").offset().top + $("#team").outerHeight();
...
if($(window).width() >= 992){ //apenas dispositivos onde são 3 membros por linha (width >= 992px)
	...
	$(window).scroll(function(){
		...
		if( MidScreen >= teamBottom && MidScreen < imgBottom){
			
			if(size < maxWidth) size = (MidScreen - teamBottom);
			else size = maxWidth;
